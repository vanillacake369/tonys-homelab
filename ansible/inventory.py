...
def main():
    ...
    # We pass the entire data domain and the deploy target to the function in inventory.nix
    nix_expr = f"(import {root_dir}/ansible/inventory.nix {{ data = (import {root_dir}/data); deploy_target = \"{deploy_target}\"; }})"
